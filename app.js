//index.js
const updateMyNumber = require('./src/class/updateMyNumber');
// dotenvの初期化
require("dotenv").config();
process.env.ROOT_PATH = __dirname;

// ライブラリの読み込み
const preinfo_db = require(process.env.ROOT_PATH +
  process.env.PREINFO_DB_CLASS_PATH);
const Preinfo_db = new preinfo_db();
const of_utils = require(process.env.ROOT_PATH +
  process.env.MYNUMBER_OFFISTA_UTILS_CLASS_PATH);
